...
(function( exports ) {
    ...
    addToLocal = function(key, dataJSON) {
        let storedData = window.localStorage.getItem(key.toString())
        if (storedData) {
            dataJSON = Object.assign(JSON.parse(storedData), dataJSON);
        }
        window.localStorage.setItem(key.toString(), JSON.stringify(dataJSON));
    },
    ...
    exports.data.addToLocal = addToLocal;
    exports.data.loadFromLocal = loadFromLocal;
